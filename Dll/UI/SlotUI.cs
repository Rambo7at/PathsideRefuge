...
public partial class SlotUI : Control
{
	...
	private void StopDrag(PlayerGUI gui)
	{
		...
		// 查找目标格子
		SlotUI targetSlot = GetHoveredSlot();
	...
	private void SwapItems(SlotUI fromSlot, SlotUI toSlot)
	{
